...
class ZesaExpress extends AbstractModule
{
    public function register_shortcodes()
    {
        add_shortcode('zesaexpress', array($this, 'render_shortcode'));
    }

    public function enqueue_scripts()
    {
        $plugin_dir = plugin_dir_path(dirname(dirname(dirname(__DIR__))) . '/api-vuejs.php') . 'assets/zesa-express/';
        $plugin_url = plugin_dir_url(dirname(dirname(dirname(__DIR__))) . '/api-vuejs.php') . 'assets/zesa-express/';
        ...
        wp_register_script('zpc_zesaexpress_js', $plugin_url . 'assets/plugin.js', array(), $plugin_js_version, true);
        wp_enqueue_script('zpc_zesaexpress_js');

        // Register and enqueue the stylesheet.
        wp_register_style('zpc_zesaexpress_css', $plugin_url . 'assets/plugin.css', array(), $plugin_css_version);
    ...
    {
        return array('zpc_zesaexpress_js');
    }
}
