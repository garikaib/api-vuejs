...
class NetOneBundles extends AbstractModule
{
    public function register_shortcodes()
    {
        add_shortcode('netone-bundles', array($this, 'render_shortcode'));
    }

    public function enqueue_scripts()
    {
        $plugin_dir = plugin_dir_path(dirname(dirname(dirname(__DIR__))) . '/api-vuejs.php') . 'assets/netone-bundles/';
        $plugin_url = plugin_dir_url(dirname(dirname(dirname(__DIR__))) . '/api-vuejs.php') . 'assets/netone-bundles/';
        ...
        wp_register_script('netone_bundles_js', $plugin_url . 'assets/plugin.js', array(), $plugin_js_version, true);
        wp_enqueue_script('netone_bundles_js');

        // Register and enqueue the stylesheet.
        wp_register_style('netone_bundles_css', $plugin_url . 'assets/plugin.css', array(), $plugin_css_version);
    ...
    {
        return array('netone_bundles_js');
    }
}
