<?php
/**
 * Display TelOne ZWL cart.
 *
 * Registers and enqueues the required scripts and styles for the TelOne ZWL cart.
 *
 * @return string HTML markup for displaying the TelOne ZWL cart.
 */
function show_telone_zwl_cart()
{
    ...
    wp_register_script('zpc_telone_zwl_js', plugin_dir_url(__FILE__) . 'assets/plugin.js', array(), $plugin_js_version, true);
    wp_enqueue_script('zpc_telone_zwl_js');

    // Register and enqueue the stylesheet.
    wp_register_style('zpc_telone_zwl_css', plugin_dir_url(__FILE__) . 'assets/plugin.css', array(), $plugin_css_version);
