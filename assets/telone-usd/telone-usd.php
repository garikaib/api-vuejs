...
{ // Get plugin.js modification time
    ...
    wp_register_script('zpc_telone_usd_js', plugin_dir_url(__FILE__) . 'assets/plugin.js', array(), $plugin_js_version, true);
    wp_enqueue_script('zpc_telone_usd_js');

    // Register and enqueue the stylesheet.
    wp_register_style('zpc_telone_usd_css', plugin_dir_url(__FILE__) . 'assets/plugin.css', array(), $plugin_css_version);
